...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/questionary-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11418&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/questionary-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `questionary` can be installed with:

```
conda install questionary
```

It is possible to list all of the versions of `questionary` available on your platform with:
